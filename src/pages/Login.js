...
export default class Login extends Component {
    ...
    login = async () => {
        ...
        let valido = false;
        try{
            // valido = await Usuario.login('loc@park.com','123456');
            valido = await Usuario.login(email, password);
            console.log(`Login ${valido ? 'Realizado!' : 'Falhado!'}`);
