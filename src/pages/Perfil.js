...
export default class Perfil extends React.Component {
    ...
    salvarDados = async () => {
        ...
        if (this.inputsValidos()) {
            try {
                let url = await BancoDados.uploadFoto(local, 'Perfil');
                ...
                valido = await BancoDados.atualizar(this.state);
                if(valido)
                    this.voltarHome();
                return;
            } catch (error) {
    ...
    excluir = async () => {
        let valido = false;
        try {
            valido = await BancoDados.excluir();
            if(valido)
    ...
    carregarDados = async () => {
        this.setState({
            foto: BancoDados.contaUsuario.foto,
            nome: BancoDados.contaUsuario.nome,
            sobrenome: BancoDados.contaUsuario.sobrenome,
            cpf: BancoDados.contaUsuario.cpf,
            celular: BancoDados.contaUsuario.celular,
            email: BancoDados.contaUsuario.email,
            password: BancoDados.contaUsuario.password,
        });
    }
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.containerHeader}>
                    ...
                    >
                        <Text style={styles.textGradient}>PERFIL</Text>
                    </LinearTextGradient>
